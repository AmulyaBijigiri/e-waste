				...
				'<td>'+
					'<div class="form-group">'+
						'<select class="form-control" name="gadgetType[]" id="gadgetType'+count+'" onchange="getGadgetPrice('+count+')" >'+
							...
							'<option value="" selected>TV</option>';
							'<option value="" selected>laptop</option>';
							'<option value="" selected>stabilizer</option>';
...
function phonenumber() {
  // var phoneno =/^(?:254|\+91|0)?(7(?:(?:[129][0-9])|(?:0[0-8])|(4[0-1]))[0-9]{6})$/;
  var phoneno =/^(?:254|\+91|0)?((7|1)(?:(?:[129][0-9])|(?:0[0-8])|(4[0-1]))[0-9]{6})$/;
